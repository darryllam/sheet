...
brspeechmos_db_root=/data/group1/z44476r/Corpora/brspeechmos # change this to your dataset folder
datadir="../brspeechmos/data"
domain_idx=0
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    ../brspeechmos/local/data_prep.py \
        --original-path "${brspeechmos_db_root}/test.csv" --wavdir "${brspeechmos_db_root}" --out "${datadir}/brspeechmos_test.csv"
fi
